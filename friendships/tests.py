...
class FriendshipServiceTests(TestCase):
    ...
    def test_get_following(self):
        ...
        following_user_id_set = FriendshipService.get_following_user_id_set(self.linghu.id)
        self.assertEqual(following_user_id_set, {user1.id, user2.id, self.dongxie.id})
